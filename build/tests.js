...
(() => {
  ...
  var ObjectType = (() => {
    const { memoize: memoize15 } = Helpers;
    ...
    function make3(name) {
      ...
      const inst = freeze3({
        ...
        uid: makeUidFor(name),
        setLookUp,
        asSingluarParameter: memoize15(asSingluarParameter)
      });
...
${inst.errors()[0]?.message}`);
  ...
  var FnClosePositionRetrieval = class_4;
